...
export const SERIES: Series[] = [
  {
    ...
    episodes: [
      { ep: 1, title: '엄마의 부탁',       duration: 92, videoUrl: 'https://www.youtube.com/watch?v=SDHfDKmriks' },
      { ep: 2, title: '바람잡이 친구',     duration: 88, videoUrl: 'https://youtube.com/shorts/ISxZQaxOyFw?si=3gmrFScu5nnIJtgy' },
      { ep: 3, title: '세 번째는 다르겠지', duration: 95, videoUrl: 'https://youtube.com/shorts/j_zllURIuLE?si=9xNqAuQpcEKty92Z' },
      { ep: 4, title: '카페에서 만난 남자', duration: 100, videoUrl: 'https://youtube.com/shorts/5G8HIsLD1Fc?si=JjUX0eM07SRtk-2x' },
      { ep: 5, title: '우연은 두 번',       duration: 104, videoUrl: 'https://youtube.com/shorts/bzeWyjML1_M?si=-BRL6s8Ry4m61Jjl' },
    ],
  },
  {
    id: 'midnight-store',
    ...
    poster: '//news.nateimg.co.kr/orgImg/pt/2025/06/25/202506251513774807_685b93d6d6ee9.jpg',
    genre: '스릴러',
    season: 2,
    totalEp: 20,
    stills: [
    ...
    episodes: [
      { ep: 1, title: '첫 손님',        duration: 98, videoUrl: 'https://youtube.com/shorts/Imw8FeLW8e4?si=Ji8B3AlYyDKn4rRz' },
      { ep: 2, title: '거스름돈',       duration: 105, videoUrl: 'https://youtube.com/shorts/g1tI1WUxWtQ?si=eNmN906328hPz5DX' },
      { ep: 3, title: '신선식품 코너',  duration: 110, videoUrl: 'https://youtube.com/shorts/5USNBU3MPro?si=coskwAyWwLFkJQ1f' },
      { ep: 4, title: '계산대 앞',      duration: 98, videoUrl: 'https://youtube.com/shorts/Xi9hUuOOVM0?si=8J9-aXdozECqASgF' },
      { ep: 5, title: '셔터를 내릴 때', duration: 112, videoUrl: 'https://youtube.com/shorts/BQAEHbUEyaw?si=PTeV97G-tkDXf7qF' },
    ],
  },
  {
    id: 'secretly',
